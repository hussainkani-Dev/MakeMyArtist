...
const services = [
  {
    ...
    description:
      "A blunt cut bob is a shorter hairstyle that's clean and modern.",
    added: false,
  },
  {
    id: "2",
    ...
    description:
      "Lob haircut is a women's hairstyle that is cut somewhere between.",
    added: true,
  },
  {
    id: "3",
    ...
    description:
      "Layered hair is a hairstyle that gives the illusion of volume.",
    added: true,
  },
  {
    id: "4",
...
export default function ShopDetailsInfo() {
  return (
    ...
    <Text className="flex-1 text-center text-xl font-bold text-black mr-10">
      Shop Details
    </Text>
  </View>
        <ScrollView
        ...
        >
          {/* Title & Address */}
          <Text className="text-2xl font-bold mt-4">Plush Beauty Lounge</Text>
          ...
          <Text className="text-gray-500 leading-7 mt-5">
            ...
            Lounge recognizes the need for constant improvement. Our team
            receives regular training from hairdressers all over the world.
          </Text>

          <Text className="text-gray-500 leading-7 mt-5">
            Keeping up to speed with the market latest trends, Plush Beauty
            Lounge recognizes the need for constant improvement. Our team
            receives regular training from hairdressers all over the world.
          </Text>
          <TouchableOpacity>
          ...
          <View className="flex-row mb-5">
            <TouchableOpacity className="bg-[#fceafb] border border-primary-pink rounded-full px-5 py-3 mr-3 flex-row items-center">
              <FontAwesome5 name="cut" size={14} color="#CF2475" />
              <Text className="text-prborder-primary-pink ml-2 font-medium">Haircut</Text>
            </TouchableOpacity>
              ...
              <View className="flex-1 ml-4">
                <View className="flex-row justify-between">
                  <View className="flex-1 pr-2">
                    ...
                    <Text className="text-primary-pink font-bold mt-1">
                      {item.price}
                    </Text>
                  </View>
                  {item.discount !== "" && (
                ...
                <View className="items-end mt-2">
                  <TouchableOpacity
                    className={`w-9 h-9 rounded-full justify-center items-center ${
                      item.added ? "bg-[#8a0f7e]" : "bg-red-100"
                    }`}
                  >
                    <MaterialIcons
          ...
          {/* View All */}
          <TouchableOpacity onPress={() => router.push("/screens/ServiceMenu")} className="border border-primary-pink rounded-full h-12 justify-center items-center mt-2 mb-6">
          ...
          <View className="flex-row justify-between items-center mt-4">
            ...
            <TouchableOpacity>
              <Text className="text-primary-pink font-medium">View all</Text>
            </TouchableOpacity>
          </View>
          <ScrollView
            horizontal
      ...
      <View className="bg-white px-6 py-4 border-t border-gray-200 flex-row items-center justify-between">
        <View>
          ...
          <Text className="text-2xl font-bold">
            AED 40
            <Text className="text-gray-400 text-base line-through"> AED 10</Text>
          </Text>
        </View>

        <TouchableOpacity className="w-12 h-12 rounded-full border border-primary-pink justify-center items-center">
          <Ionicons name="chatbubble-ellipses" size={22} color="#CF2475" />
        </TouchableOpacity>

        <TouchableOpacity  onPress={() => router.push("/screens/book-service")} className="bg-secondary-purple rounded-full px-10 h-12 justify-center">
